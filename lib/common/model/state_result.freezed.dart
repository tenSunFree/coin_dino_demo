...
class _$StateResultTearOff {
  ...
  Failed<T> failed<T>(ResultErrorData data) {
    return Failed<T>(
      data,
    );
  }
...
mixin _$StateResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ResultErrorData data) failed,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(ResultErrorData data)? failed,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Failed<T> implements Failed<T> {
  ...
  @override
  final ResultErrorData data;

  @override
  String toString() {
    return 'StateResult<$T>.failed(data: $data)';
  }
...
abstract class Failed<T> implements StateResult<T> {
  const factory Failed(ResultErrorData data) = _$Failed<T>;

  ResultErrorData get data => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $FailedCopyWith<T, Failed<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
