...
class _$ResultTearOff {
  ...
  Failure<T> failure<T>(ResultErrorData failure) {
    return Failure<T>(
      failure,
    );
  }
...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ResultErrorData failure) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T data)? success,
    TResult Function(ResultErrorData failure)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class $FailureCopyWith<T, $Res> {
  ...
  $Res call({ResultErrorData failure});
}
...
abstract class Failure<T> implements Result<T> {
  const factory Failure(ResultErrorData failure) = _$Failure<T>;

  ResultErrorData get failure => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $FailureCopyWith<T, Failure<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
